...
public class Grid {
    ...
    public void init(){
        ...
        //*** Obstacle list reviewed on Feb.8. It shows all obstacles defined
        //*** on the google docs doc we did on Saturday. Needs to be compared to Rafa's design.
        // Maybe here we could implement one of the classes that can be inside others. "Obstacles" so it's more of a capsule?
